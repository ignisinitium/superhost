...
// UFW rule numbers
// ---------------------------------------------------------------------------
export function validateRuleNumber(n) {
    const num = Number(n);
...
export function validateServiceAction(action) {
    if (typeof action !== 'string')
        throw new Error('Service action must be a string');
...
export function validatePm2Action(action) {
    if (typeof action !== 'string')
        throw new Error('PM2 action must be a string');
    const trimmed = action.trim().toLowerCase();
 ...
 */
export async function validatePath(inputPath, baseDir) {
 ...
 */
export function validatePathSync(inputPath, baseDir) {
    if (typeof inputPath !== 'string')
        throw new Error('Path must be a string');
    const joined = path.normalize(path.join(baseDir, inputPath));
...
export function validateEmailLocalPart(local) {
    if (typeof local !== 'string')
        throw new Error('Email local part must be a string');
...
export function validateMysqlIdentifier(name, label = 'identifier') {
    if (typeof name !== 'string')
...
export function validateCronField(field, label) {
    if (typeof field !== 'string')
        throw new Error(`Cron ${label} must be a string`);
...
export function validateCronCommand(command) {
    if (typeof command !== 'string')
        throw new Error('Cron command must be a string');
    const trimmed = command.trim();
    if (trimmed.length === 0)
        throw new Error('Cron command cannot be empty');
    if (trimmed.length > 1000)
        throw new Error('Cron command too long');
...
// ---------------------------------------------------------------------------
export function validateLineCount(lines, max = 10000) {
...
export function validatePhpVersion(version) {
    if (typeof version !== 'string')
        throw new Error('PHP version must be a string');
...
export function validateDnsType(type) {
    if (typeof type !== 'string')
        throw new Error('DNS record type must be a string');
