...
router.post('/assign', async (req, res) => {
    ...
    try {
        ...
        const result = await query('INSERT INTO user_ports (user_id, port, service_name, domain_id) VALUES ($1, $2, $3, $4) RETURNING *', [userId, nextPort, serviceName, domainId]);
        // Create task for worker to setup reverse proxy and systemd service
        await query('INSERT INTO tasks (command, payload) VALUES ($1, $2)', ['SETUP_CUSTOM_API', { userId, port: nextPort, serviceName, domainId }]);
