...
router.get('/', async (req, res) => {
    try {
        ...
        const taskRes = await query('INSERT INTO tasks (command, payload) VALUES ($1, $2) RETURNING id', ['GET_PROCESSES', {}]);
        res.json({ taskId: taskRes.rows[0].id, message: 'Fetching system processes...' });
    }
    catch (err) {
