...
function generateDovecotPassword(plainPassword) {
...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        const result = await query('INSERT INTO mail_users (domain_id, email, password_hash, quota) VALUES ($1, $2, $3, $4) RETURNING id, email, quota', [mailDomainId, fullEmail, dovecotHash, quota]);
