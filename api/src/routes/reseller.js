...
router.post('/', async (req, res) => {
    ...
    try {
        const result = await query('INSERT INTO resellers (admin_id, company_name, plan_tier, max_users) VALUES ($1, $2, $3, $4) RETURNING *', [adminId, companyName, planTier || 'standard', maxUsers || 10]);
...
router.post('/keys', async (req, res) => {
    ...
    try {
        ...
        await query('INSERT INTO api_keys (owner_id, key_prefix, key_hash, label, permissions) VALUES ($1, $2, $3, $4, $5)', [req.adminId, prefix, hash, label, JSON.stringify(permissions || [])]);
