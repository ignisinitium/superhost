...
router.post('/scan', async (req, res) => {
    ...
    try {
        ...
        const taskRes = await query('INSERT INTO tasks (command, payload) VALUES ($1, $2) RETURNING id', ['SCAN_MALWARE', { userId, username }]);
...
router.post('/block-ip', async (req, res) => {
    ...
    try {
        await query('INSERT INTO blocked_ips (ip_address, reason) VALUES ($1, $2) ON CONFLICT (ip_address) DO UPDATE SET reason = $2', [ipAddress, reason || 'Manual block by administrator']);
        await query('INSERT INTO tasks (command, payload) VALUES ($1, $2)', ['FIREWALL_BLOCK_IP', { ipAddress }]);
