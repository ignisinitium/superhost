...
router.post('/', async (req: AuthRequest, res) => {
  ...
  try {
    ...
    const result = await query(
      'INSERT INTO ftp_accounts (user_id, ftp_username, password_hash, homedir) VALUES ($1, $2, $3, $4) RETURNING id, ftp_username, homedir, created_at',
      [req.userId, fullFtpUsername, passwordHash, targetDir]
    );
